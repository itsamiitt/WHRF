...
export function SiteShell({ children, variant = "other", includeHomeScripts = false }: SiteShellProps) {
  return (
    <>
...
function WhatsAppFab() {
  return (
    <a
      href="https://wa.me/91XXXXXXXXXX?text=Hi%20WRHWFOUR%2C%20I%20need%20IT%20support"
      target="_blank"
      rel="noopener"
